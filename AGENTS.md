...
- 人工待办：① 按 `docs/video-upload-copy.md` 审定当前合成旁白（或重录人声），上传 Demo 视频并匿名测试 URL；② 填 DoraHacks 真实姓名/邮箱/国籍与 eligibility；③ 将 GitHub 仓库重命名为 AttestFlow 品牌名并补齐 About/topics/social preview；④ 全部外链匿名复查；⑤ 点击提交并复查 portal。
